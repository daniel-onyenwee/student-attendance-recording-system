...
ClassAttendeeRoute.get("/:classAttendanceId/class-attendee", idValidator("classAttendanceId"), async (req, res) => {
...
ClassAttendeeRoute.post("/:classAttendanceId/class-attendee", idValidator("classAttendanceId"), async (req, res) => {
    const prismaClient: PrismaClient = req.app.get("prisma-client")

    let classAttendanceId = req.params.classAttendanceId

    let body: ClassAttendeeRouteRequestBody | null = req.body || { classAttendees: [] }
...
ClassAttendeeRoute.delete("/:classAttendanceId/class-attendee", async (req, res) => {
    const prismaClient: PrismaClient = req.app.get("prisma-client")
